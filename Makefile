...
all: info libidata.so leerlogerbd cgi killpid sftpclient AxionMain leermodbus axismbus yunlogger test yuncontrol enviosaih
...
enviosaih: enviosaih.o libidata.so
	$(CC) -o $@ $@.o -L. -lidata

enviosaih.o: src/enviosaih.c
	$(CC) -c src/enviosaih.c 
...
axismbus: axismodbus.o libidata.so
	$(CC) axismodbus.o -o axismbus -L. -lidata -lpthread
...
leermodbus: leermodbus.o libidata.so
	$(CC) $(CFLAGS) leermodbus.o -o leermodbus -L. -lidata 
